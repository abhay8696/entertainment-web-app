...
const ModalComp = () => {
    ...
    const load = async () => {
        ...
        setImageCollection(
            imageCollection?.posters || imageCollection?.backdrops
        );
    };
    const toggleModal = () => {
        ...
        return (
            <ul className="moreData_in_modal text-sm">
                ...
                <li>
                    ...
                    <a href={homepage} target="_blank" className="underline">
                        {homepage}
                    </a>
                </li>
                <li>
    ...
    return (
        ...
        >
            ...
            <div className="Modal p-4 lg:px-9 text-left flex flex-col gap-2">
                ...
                <div className="modalHead py-2 md:py-4 flex gap-4 items-center md:rounded-xl">
                    ...
                    <div className="flex-1">
                        <h3
                            className="modalTitle md:text-5xl lg:text-8xl"
                            onClick={() => console.log(moreData)}
                        >
                            {" "}
                            {title}{" "}
                        </h3>
                        <p className="modalTagline  md:text-2xl lg:text-2xl text-italic">
                            {moreData?.tagline}
                        </p>
                        <p className="modalOverview hidden md:block max-w-[750px] mt-4">
                            {overview}
                        </p>
                    </div>
                </div>
                ...
                {imageCollection ? (
                    <ImagesGrid images={imageCollection} />
                ) : null}
            </div>
        </div>
    );
